...
//            else
//            {
//                Console.WriteLine("File not found: '" + matchesFile + "'");
...
//        public void OnDisconnect(ChatBot.DisconnectReason disconnectReason, string message)
//        {
